...
//==============================================================================
@interface DPTResizableBuffer ()

@property (nonatomic)           void* buffer;     // Pointer to actual memory
@property (nonatomic,readwrite) int   objectSize; // Size of objects stored in buffer
@property (nonatomic,readwrite) int   capacity;   // max # items of objectSize which can be stored in buffer without resizing

@end


//==============================================================================
@implementation DPTResizableBuffer

#pragma mark - Init Methods

+ (id)bufferWithCapacity:(int)capacity ofObjectSize:(int)objSize {
    return [[DPTResizableBuffer alloc] initWithCapacity:capacity ofObjectSize:objSize];
}
...
- (id)copyWithZone:(NSZone*)zone {
    DPTResizableBuffer* newObj = [DPTResizableBuffer bufferWithCapacity:self.capacity ofObjectSize:self.objectSize];
...
#pragma mark - NSCoding Implementation (doesn't work!)
